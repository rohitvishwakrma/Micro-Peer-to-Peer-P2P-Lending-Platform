...
import { Wallet, TrendingUp, DollarSign, Briefcase, Loader } from 'lucide-react';
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div className="bg-white rounded-xl p-5 border-l-4 border-blue-500">
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-blue-600">₹{Math.round(stats.expectedReturns).toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white rounded-xl p-5 border-l-4 border-purple-500">
          <div className="flex justify-between">
            <div>
              <p className="text-gray-500 text-sm">Realized Returns</p>
              <p className="text-2xl font-bold text-purple-600">₹{Math.round(stats.realizedReturns).toLocaleString()}</p>
            </div>
        ...
        <div className="bg-white rounded-xl p-5 border-l-4 border-orange-500">
          <div className="flex justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">Avg ROI: {stats.averageInterest.toFixed(1)}%</p>
            </div>
