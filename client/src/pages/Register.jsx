...
import { Coins, User, Mail, Lock, Phone, Briefcase, UserCheck, ArrowRight } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" onClick={() => setFormData({...formData, role: 'borrower'})}
                ...
                <Briefcase className="h-5 w-5" /><span>Borrower</span>
              </button>
              <button type="button" onClick={() => setFormData({...formData, role: 'lender'})}
                ...
                <UserCheck className="h-5 w-5" /><span>Lender</span>
              </button>
            </div>
          </div>
          ...
          <button type="submit" disabled={loading}
            ...
            {loading ? 'Creating account...' : <><ArrowRight className="h-5 w-5" /> Register</>}
          </button>
        </form>
