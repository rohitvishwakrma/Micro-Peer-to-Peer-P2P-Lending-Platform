...
import { Eye, TrendingUp, X, Loader } from 'lucide-react';
        ...
        <table className="w-full">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-600">Tenure</th>
              <th className="px-4 py-3 text-left text-sm font-medium text-gray-600">Monthly EMI</th>
      ...
      {selectedInvestment && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl w-full max-w-md">
            <div className="flex justify-between items-center p-5 border-b"><h3 className="text-lg font-bold">Investment Details</h3><button onClick={() => setSelectedInvestment(null)}><X className="h-5 w-5 text-gray-400" /></button></div>
