...
import { ArrowLeft, DollarSign, Calendar, Percent, Briefcase, FileText, Info, Loader } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-md p-6 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select value={formData.purpose} onChange={(e) => setFormData({...formData, purpose: e.target.value})}
                className="w-full pl-10 pr-4 py-3 border rounded-xl appearance-none focus:ring-2 focus:ring-blue-500" required>
          ...
          <button type="submit" disabled={loading}
            ...
            {loading ? <><Loader className="h-5 w-5 animate-spin" /> Submitting...</> : 'Submit Loan Request'}
          </button>
        </form>
      </div>
    </div>
